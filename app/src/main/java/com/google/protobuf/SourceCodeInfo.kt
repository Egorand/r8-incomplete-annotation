...
data class SourceCodeInfo(
  ...
  companion object {
    ...
    @JvmField
    val CREATOR: Parcelable.Creator<SourceCodeInfo> = AndroidMessage.newCreator(ADAPTER)
  }
  ...
  data class Location(
    ...
    companion object {
      ...
      @JvmField
      val CREATOR: Parcelable.Creator<Location> = AndroidMessage.newCreator(ADAPTER)
    }
  }
}
