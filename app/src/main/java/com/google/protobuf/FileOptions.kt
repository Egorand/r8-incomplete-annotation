...
data class FileOptions(
   ...
   */
  @field:WireField(tag = 10, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
  ...
  @Deprecated(message = "java_generate_equals_and_hash is deprecated") @field:WireField(tag = 20,
      adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField val java_generate_equals_and_hash:
      Boolean? = null,
  /**
   ...
   */
  @field:WireField(tag = 27, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
  ...
  @field:WireField(tag = 9, adapter = "com.google.protobuf.FileOptions.OptimizeMode#ADAPTER")
      @JvmField val optimize_for: OptimizeMode? = OptimizeMode.SPEED,
  /**
   ...
   */
  @field:WireField(tag = 11, adapter = "com.squareup.wire.ProtoAdapter#STRING") @JvmField
   ...
   */
  @field:WireField(tag = 16, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
      val cc_generic_services: Boolean? = false,
  @field:WireField(tag = 17, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
      val java_generic_services: Boolean? = false,
  @field:WireField(tag = 18, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
      val py_generic_services: Boolean? = false,
  @field:WireField(tag = 42, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
   ...
   */
  @field:WireField(tag = 23, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
      val deprecated: Boolean? = false,
  /**
   * Enables the use of arenas for the proto messages in this file. This applies
   * only to generated classes for C++.
   */
  @field:WireField(tag = 31, adapter = "com.squareup.wire.ProtoAdapter#BOOL") @JvmField
      val cc_enable_arenas: Boolean? = false,
  /**
   * Sets the objective c class prefix which is prepended to all objective c
   * generated classes from this .proto. There is no default.
   */
  @field:WireField(tag = 36, adapter = "com.squareup.wire.ProtoAdapter#STRING") @JvmField
      val objc_class_prefix: String? = null,
  /**
   * Namespace for generated classes; defaults to the package.
   */
  @field:WireField(tag = 37, adapter = "com.squareup.wire.ProtoAdapter#STRING") @JvmField
   ...
   */
  @field:WireField(tag = 39, adapter = "com.squareup.wire.ProtoAdapter#STRING") @JvmField
      val swift_prefix: String? = null,
  /**
   * Sets the php class prefix which is prepended to all php generated classes
   * from this .proto. Default is empty.
   */
  @field:WireField(tag = 40, adapter = "com.squareup.wire.ProtoAdapter#STRING") @JvmField
   ...
   */
  @field:WireField(tag = 41, adapter = "com.squareup.wire.ProtoAdapter#STRING") @JvmField
