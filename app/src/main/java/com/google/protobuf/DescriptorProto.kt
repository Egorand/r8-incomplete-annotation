...
data class DescriptorProto(
  ...
  companion object {
    ...
    @JvmField
    val CREATOR: Parcelable.Creator<DescriptorProto> = AndroidMessage.newCreator(ADAPTER)
  }
  ...
  data class ExtensionRange(
    ...
    companion object {
      ...
      @JvmField
      val CREATOR: Parcelable.Creator<ExtensionRange> = AndroidMessage.newCreator(ADAPTER)
    }
  }
  ...
  data class ReservedRange(
    ...
    companion object {
      ...
      @JvmField
      val CREATOR: Parcelable.Creator<ReservedRange> = AndroidMessage.newCreator(ADAPTER)
    }
  }
}
